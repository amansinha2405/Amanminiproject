...
<?php
    ...
    <header class="text-gray-600 body-font">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
            ...
            <span class="ml-3 text-xl">Aman Bloodbank centre</span>
          </a>
          <nav class="md:ml-auto flex flex-wrap items-center text-base justify-center">
            <a href="website1.html" class="mr-5 hover:text-gray-900">Home</a>
    ...
    <img class="object-cover object-center rounded" alt="hero" src="https://www.vumc.org/pmi/sites/vumc.org.pmi/files/public_files/Files/Blood%20Bank%20Transfusion%20Medicine.JPG" height="700" width="600">
    </div>
